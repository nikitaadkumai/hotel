...
class BookingController extends Controller
{
 ...
 public function CheckoutStore(Request $request){
       ...
       Notification::send($admins, new BookingComplete($request->name));
...
public function DeleteBooking($id) {
    ...
    return redirect()->back()->with(['message' => 'Booking deleted', 'alert-type' => 'success']);
}
...
{
    // Detect the correct authenticated guard
